...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'tmanager@chnnhc.com',
  ...
  protectedRoutes: ['/🌞 Private folder/u-need-a-password', '/🥟 Some test files/Protected route', '/mofar'],
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/EckCiting',
    },
  ],
